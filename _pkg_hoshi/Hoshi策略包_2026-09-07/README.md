...
1. **`01_策略机制与数据需要什么.md`** —— 策略怎么算：入场信号 5 条件、仓位规则、双门控、S3/S4 出场规则、数据格式与获取链路、运行命令。
2. **`02_实验验证结论_哪些更好.md`** —— 我们验证下来哪些更好：
...
```
├── 01_策略机制与数据要求.md          ← 策略机制 + 数据说明
├── 02_实验验证结论_哪些更好.md        ← 实验结果汇总
...
└── docs/
    ├── Hoshi_改进实验_阶段成果_2026-09-04.md   完整阶段报告（含性能瓶颈分析）
    └── Hoshi_开盘决策_2026-09-07.md            实盘决策单样例
```
...
数据链路（刷新/导出需要 pytdx + duckdb + loguru）见 `01_策略机制与数据要求.md` 第三节。
